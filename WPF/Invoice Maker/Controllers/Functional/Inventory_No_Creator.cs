...
{
    class Inventory_No_Creator
    {
        private string old_Ref;

        public Inventory_No_Creator(string inString)
        {
            old_Ref = inString;
        }
        ...
        {
            return old_Ref.Replace("STO-" + theYear(), "");
        }
        ...
        public string NewRef()
        {
            if (theSameYear())
            {
                return "STO-" + theYear() + addOneNum(exit_ref());
            }
            else
            {
                return $"STO-{theYear()}0001";
            }
        }
