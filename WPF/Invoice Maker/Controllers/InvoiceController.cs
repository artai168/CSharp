...
namespace TopStar_Invoice_Maker_SQLSever.Controllers
{
    class InvoiceController : DB.DBSettings
    {
        ...
        private void Add_Invoice_Item_byProcedure(Models.Invoice_Item inInvoice_Item, string invoice_Date)
        {
            string strSql = "dbo.usp_Invoice_Detail_Add";
            ...
            using (sqlseverConnection = new SqlConnection(DB_Connection_String))
            {
                ...
                // Command Type is StoredProcedure
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Parameters.Add("@In_Product", SqlDbType.NVarChar).Value = inInvoice_Item.Product_ID;              
                cmd.Parameters.Add("@In_Brand", SqlDbType.NVarChar).Value = brand;
                cmd.Parameters.Add("@In_Model", SqlDbType.NVarChar).Value = inInvoice_Item.Model;
                cmd.Parameters.Add("@In_Product_Desc", SqlDbType.NVarChar).Value = description;
                cmd.Parameters.Add("@In_Unit", SqlDbType.NVarChar).Value = inInvoice_Item.Unit;
                cmd.Parameters.Add("@In_Qty", SqlDbType.NVarChar).Value = inInvoice_Item.Qty;
                cmd.Parameters.Add("@In_Unit_Price", SqlDbType.NVarChar).Value = inInvoice_Item.Unit_Price;
                cmd.Parameters.Add("@In_Remark", SqlDbType.NVarChar).Value = remark;
                cmd.Parameters.Add("@In_Net_Price", SqlDbType.NVarChar).Value = inInvoice_Item.Net_Price;
                cmd.Parameters.Add("@In_Total", SqlDbType.NVarChar).Value = inInvoice_Item.Total;
                cmd.Parameters.Add("@In_Invoice_ID", SqlDbType.NVarChar).Value = inInvoice_Item.Invoice_ID;
                cmd.Parameters.Add("@In_Invoice_Date", SqlDbType.DateTime2).Value = invoice_Date;
        ...
        */
        ...
        private void Save_Invoice_N_Items(Models.Invoice inInvoice)
        {
            ...
            {
                //Add_Invoice_Item(tempItem);
                Add_Invoice_Item_byProcedure(tempItem, inInvoice.Invoice_Date);
            }
        }
...
//            str_Sql += "CONVERT(varchar," + clinic_Table.TableName + "." + clinic_Table. + ", 105) AS " + clinic_Table.Due_Date + " , ";
        ...
        public Models.Invoice get_the_Invoice(string inInvoiceID)
        {
            ...
            string str_Sql = "SELECT  ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Clinic_ID + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Clinic_Name + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Address + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.ContactPerson + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Telephone + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.SHIPTO_Clinic_Name + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.SHIPTO_Address + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.SHIPTO_ContactPerson + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.SHIPTO_Telephone + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Delivery + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.District + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Payment_Terms + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Invoice_ID + ", ";
            str_Sql += "CONVERT(varchar," + invoice_Table.TableName + "." + invoice_Table.Invoice_Date + ", 105) AS " + invoice_Table.Invoice_Date + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Sales_Person + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.CustomerReferenceCode + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Discount + ", ";
            str_Sql += "CONVERT(varchar," + invoice_Table.TableName + "." + invoice_Table.Due_Date + ", 105) AS " + invoice_Table.Due_Date + " , ";
            //            str_Sql += "CONVERT(varchar," + invoice_Table.TableName + "." + invoice_Table. + ", 105) AS " + invoice_Table.Due_Date + " , ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.INV_Status + ", ";

            str_Sql += invoice_Table.TableName + "." + invoice_Table.Total + ", ";
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Remark + " ";
            str_Sql += " FROM " + invoice_Table.TableName;
            str_Sql += " WHERE " + invoice_Table.Invoice_ID + "=  '" + inInvoiceID + "'";
        ...
        public List<Models.Invoice> Get_Invoice_For_Statement(string inClinicID)
        {
            Controllers.DataMapping.Invoice_Table invoice_Table = new DataMapping.Invoice_Table();
            List<Models.Invoice> temp_Invoice_List = new List<Models.Invoice>();
            ...
            str_Sql += invoice_Table.TableName + "." + invoice_Table.Remark + " ";
            str_Sql += " FROM " + invoice_Table.TableName;
            str_Sql += " WHERE ((" + invoice_Table.Clinic_ID + "=  '" + inClinicID + "') ";
            str_Sql += " AND (" + invoice_Table.INV_Status + "=  'OPEN'))";
            ...
            using (sqlseverConnection = new SqlConnection(DB_Connection_String))
            {
                ...
                try
                {
                    ...
                    if (theData.HasRows)
                    {
                        while (theData.Read())
                        {
                            temp_Invoice_List.Add(new Models.Invoice
                            {
                                Clinic_ID = theData[invoice_Table.Clinic_ID].ToString(),
                                Clinic_Name = theData[invoice_Table.Clinic_Name].ToString(),
                                Address = theData[invoice_Table.Address].ToString(),
        ...
        public string get_Last_Price(string inCustomerID, string inProductID)
        {
            Controllers.DataMapping.Invoice_Table invoice_Table = new DataMapping.Invoice_Table();
            Controllers.DataMapping.Invoice_Item_Table clinic_Item_Table = new DataMapping.Invoice_Item_Table();
            ...
            string str_Sql = "SELECT";
            str_Sql += " TOP(1) dbo.INV_Product_Data.Net_Price";
            str_Sql += " FROM";
            str_Sql += " dbo.INV_Data";
            str_Sql += " INNER JOIN dbo.INV_Product_Data ON dbo.INV_Data.INVOICE_NO = dbo.INV_Product_Data.Invoice_ID";
            str_Sql += " WHERE((INV_Data.Customer_ID = '" + inCustomerID + "') AND(INV_Product_Data.Product_ID = '"+ inProductID + "'))";
            str_Sql += " ORDER BY INV_Data.INVOICE_DATE DESC";
            ...
            using (sqlseverConnection = new SqlConnection(DB_Connection_String))
            {
                ...
                try
                {
                    ...
                    if (theData.HasRows)
                    {
                        while (theData.Read())
                        {
                            strResult = theData[clinic_Item_Table.Net_Price].ToString();
                        }
                    }
                }
                catch (Exception ex)
        ...
        public List<Models.Invoice> get_opened_InvoiceItems(string inCustomerID)
        {
            ...
            str_Sql += " AND " + invoice_Table.INV_Status + "<>  'PAID'";
        ...
        public void SaveInvoice(Models.Invoice inInvoice)
        {
            ...
            */
            ...
            Controllers.Excel.InvoiceMaker.InvoiceMaker_EPPlus invoiceMaker = new Excel.InvoiceMaker.InvoiceMaker_EPPlus(inInvoice);
            invoiceMaker.MakeNewInvoice();
